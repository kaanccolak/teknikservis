...
const navItems: {
  ...
  { href: "/is-emirleri", label: "İş Emirleri", icon: ClipboardList, permKey: "canViewIsEmirleri" },
    ...
    <>
      ...
      <aside
        className={cn(
          ...
          "lg:sticky lg:top-0 lg:z-auto lg:h-screen lg:w-48 lg:translate-x-0 lg:shrink-0",
          mobileOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0",
        )}
      >
        <div className="flex flex-col h-screen overflow-hidden">
        <div className="border-b border-slate-100 px-5 py-4 lg:px-3 lg:py-3">
          <div
            style={{
              display: "flex",
              alignItems: "center",
          ...
          {navItems
            ...
            return (
              <Link
                ...
                className={cn(
                  "flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium transition-colors lg:px-2.5 lg:py-1.5 lg:text-xs",
                  active
        ...
        <div className="border-t border-slate-200/80 px-3 py-2 space-y-1">
          {aktifPersonelAdi && (
