...
export const KURULUM_TURLERI: KurulumTur[] = [
  ...
  },
  {
    ...
    markalar: [
      { ad: "Sony", modeller: [{ ad: "PlayStation 5" }, { ad: "PlayStation 5 Slim" }, { ad: "PlayStation 4 Pro" }, { ad: "PlayStation 4" }, { ad: "PlayStation 3" }, { ad: "PlayStation Portable" }, { ad: "PlayStation Vita" }, { ad: "DualSense Kontrolcü" }, { ad: "DualShock 4" }] },
      { ad: "Microsoft", modeller: [{ ad: "Xbox Series X" }, { ad: "Xbox Series S" }, { ad: "Xbox One X" }, { ad: "Xbox One S" }, { ad: "Xbox One" }, { ad: "Xbox 360" }, { ad: "Xbox Elite Kontrolcü" }] },
